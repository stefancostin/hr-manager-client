...
export class OrdersChartComponent implements AfterViewInit, OnInit, OnDestroy, OnChanges {
  ...
  ngOnChanges(): void {
    if (this.option) {
      ...
      setTimeout(() => {
        this.updateOrdersChartOptions(this.timelineChartData);
      });
    }
  }
  ...
  constructor(private theme: NbThemeService,
    ...
    this.statisticService.getTimelineChart().subscribe(resp => {
      this.timelineChartData = resp.data;
    });
  }
  ...
  ngAfterViewInit(): void {
    this.theme.getJsTheme()
      ...
      .subscribe(config => {
        ...
        // console.log('ORDERS', this.ordersChartData);
        // console.log('ORDERS', this.timelineChartData);
      });
  }
