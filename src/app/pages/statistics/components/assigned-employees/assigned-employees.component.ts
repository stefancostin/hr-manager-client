...
@Component({
  selector: 'hr-assigned-employees',
  templateUrl: './assigned-employees.component.html',
  styleUrls: ['./assigned-employees.component.scss']
})
export class AssignedEmployeesComponent implements AfterViewInit, OnInit, OnDestroy {
  public option: any = {};
  ...
  constructor(private theme: NbThemeService,
    ...
    this.statisticService.getAssignedEmployees().subscribe(resp => {
      this.value = resp.data.assignedPercentage;
